    ...
    case 'update'
       ...
       % set(BpodSystem.GUIHandles.OutcomePlot.Aud,'xdata',find(BpodSystem.Data.Custom.AuditoryTrial),'ydata',BpodSystem.Data.Custom.DV(BpodSystem.Data.Custom.AuditoryTrial));
        ...
        if TaskParameters.GUI.ShowVevaiometric
            ...
            WTcorr = grpstats(BpodSystem.Data.Custom.FeedbackTime(ndxCorrect),BinIdx(ndxCorrect),'mean')';
        ...
        if TaskParameters.GUI.ShowFeedback
            ...
            BpodSystem.GUIHandles.OutcomePlot.HistErr = histogram(AxesHandles.HandleFeedback,BpodSystem.Data.Custom.FeedbackTime(ndxError)*1000);
            BpodSystem.GUIHandles.OutcomePlot.HistErr.BinWidth = 50;
            ...
            BpodSystem.GUIHandles.OutcomePlot.HistCorr = histogram(AxesHandles.HandleFeedback,BpodSystem.Data.Custom.FeedbackTime(ndxCorrect)*1000);
            BpodSystem.GUIHandles.OutcomePlot.HistCorr.BinWidth = 50;
