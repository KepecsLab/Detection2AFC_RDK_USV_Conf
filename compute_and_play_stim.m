...
%     BpodSystem.Data.Custom.dots = dots;
    ...
    if (BpodSystem.Data.Custom.num_calls < TaskParameters.GUI.MinSample*60) ||  (BpodSystem.Data.Custom.num_calls > (TaskParameters.GUI.MinSample + TaskParameters.GUI.StimSignalLen)*60)%60 frames per second
        dx = dots.drx;
        dy = dots.dry;
    ...
    %update the dot position
    [dots.x, dots.y] = move_dots(dots.x, dots.y, dx, dy);
