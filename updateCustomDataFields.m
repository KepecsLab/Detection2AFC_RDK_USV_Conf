...
BpodSystem.Data.Custom.RewardMagnitude(iTrial) = NaN;
...
if any(strncmp('Lin',statesThisTrial, 3))
    BpodSystem.Data.Custom.ChoiceLeft(iTrial) = 1;
elseif any(strncmp('Rin',statesThisTrial, 3))
...
if any(strcmp('Rewarded_Bin_Wait3',statesThisTrial))
    ...
    BpodSystem.Data.Custom.FeedbackTime(iTrial) = FeedbackPortTimes(end,end);
...
if iTrial > 0%numel(BpodSystem.Data.Custom.DV) - 2
    ...
    switch TaskParameters.GUI.StimulusType
        ...
        case 3 %dots
            ...
            coherence = BpodSystem.Data.Custom.Coherence(b);
            if dots{b}.direction == 0
                coherence = 0;
            end
            [dirs, dx, dy] =...
                compute_dirs(num_trials, dots{b}.nDots,coherence,...
                dots{b}.direction, dots{b}.speed,60);
            
            incoherent_dots = dirs ~= dots{b}.direction;
            %ideally only the coherent dots get their direction updated?
           [rdirs, drx, dry] = compute_dirs(num_trials, dots{b}.nDots, 0,...
                dots{b}.direction, dots{b}.speed,60);
            
            dx(incoherent_dots) = drx(incoherent_dots);
            dy(incoherent_dots) = dry(incoherent_dots);
            ...
            BpodSystem.Data.Custom.CenterRewarded(b) = BpodSystem.Data.Custom.correct_side(b) == 0;
            BpodSystem.Data.Custom.LeftRewarded(b)= BpodSystem.Data.Custom.correct_side(b) < 0;
            BpodSystem.Data.Custom.RightRewarded(b)= BpodSystem.Data.Custom.correct_side(b) > 0;
